...
Blockly.Workspace.prototype.deleteVariable = function(a) {
    for (var b = this.getVariableUses(a), c = 0, d; d = b[c]; c++)
        //ANKE METHOD - add the last 2 in IF
        if ("procedures_defnoreturn" == d.type || "procedures_defreturn" == d.type /*|| "procedures_defreturn_io" == d.type || "procedures_defnoreturn_io" == d.type*/) {
        //-----
...
Blockly.Procedures.flyoutCategory = function(a) {
    ...
    //ANKE METHOD - add IF
    /*if (Blockly.Blocks.procedures_defnoreturn_io) {
        var d = goog.dom.createDom("block");
        d.setAttribute("type", "procedures_defnoreturn_io");
        d.setAttribute("gap", 16);
        var e = goog.dom.createDom("field", null, Blockly.Msg.PROCEDURES_DEFNORETURN_PROCEDURE);
        e.setAttribute("name", "NAME");
        d.appendChild(e);
    ...
    //ANKE METHOD - add line
    //Blockly.Blocks.procedures_defreturn_io && (d = goog.dom.createDom("block"), d.setAttribute("type", "procedures_defreturn_io"), d.setAttribute("gap", 16), e = goog.dom.createDom("field", null, Blockly.Msg.PROCEDURES_DEFRETURN_PROCEDURE), e.setAttribute("name", "NAME"), d.appendChild(e), c.push(d));
    //---
