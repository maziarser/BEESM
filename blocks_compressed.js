...
//ANKE METHOD - add the following 2 functions
/*Blockly.Blocks.procedures_defnoreturn_io = {
    init: function() {
        var a = new Blockly.FieldTextInput("", Blockly.Procedures.rename);
        a.setSpellcheck(!1);
        this.appendDummyInput().appendField(Blockly.Msg.PROCEDURES_DEFNORETURN_TITLE).appendField(a, "NAME").appendField("", "PARAMS");
...
//------------------------------------------------------
Blockly.Blocks.procedures_defreturn_io = {
    init: function() {
        var a = new Blockly.FieldTextInput("", Blockly.Procedures.rename);
        a.setSpellcheck(!1);
        this.appendDummyInput().appendField(Blockly.Msg.PROCEDURES_DEFRETURN_TITLE).appendField(a, "NAME").appendField("", "PARAMS");
...
Blockly.Blocks.procedures_ifreturn = {
    ...
    onchange: function() {
        if (this.workspace.isDragging && !this.workspace.isDragging()) {
            ...
            //ANKE - add _io
            a ? ("procedures_defnoreturn" == b.type /*|| "procedures_defnoreturn_io" == b.type*/ && this.hasReturnValue_ ? (this.removeInput("VALUE"), this.appendDummyInput("VALUE").appendField(Blockly.Msg.PROCEDURES_DEFRETURN_RETURN), this.hasReturnValue_ = !1) : "procedures_defreturn" != b.type || /*"procedures_defreturn_io" != b.type ||*/ this.hasReturnValue_ || (this.removeInput("VALUE"), this.appendValueInput("VALUE").appendField(Blockly.Msg.PROCEDURES_DEFRETURN_RETURN), this.hasReturnValue_ = !0), this.setWarningText(null), this.isInFlyout || this.setDisabled(!1)) : (this.setWarningText(Blockly.Msg.PROCEDURES_IFRETURN_WARNING),
                this.isInFlyout || this.getInheritedDisabled() || this.setDisabled(!0))
            //-----
        }
    },
    FUNCTION_TYPES: ["procedures_defnoreturn", "procedures_defreturn", "procedures_defnoreturn_io", "procedures_defreturn_io"]
};
